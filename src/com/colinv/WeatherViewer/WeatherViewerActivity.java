...
import com.colinv.WeatherViewer.AddCityDialogFragment.DialogFinishedListener;
import com.colinv.WeatherViewer.CitiesFragment.CitiesListChangeListener;
import com.colinv.WeatherViewer.ReadLocationTask.LocationLoadedListener;
...
public class WeatherViewerActivity extends Activity implements DialogFinishedListener {
    ...
    public static final String WIDGET_UPDATE_BROADCAST_ACTION =
            "com.colinv.WeatherViewer.UPDATE_WIDGET";
    ...
    // initialize this Activity and inflates its layout from xml
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        listCitiesFragment.setCitiesListChangeListener(citiesListChangeListner);
        ...
        weatherSharedPreferences = getSharePreferences(SHARED_PREFERENCES_NAME, MODE_PRIVATE);
    ...
    public void onResume()
    {
        ...
        getActionBar().selectTab(getActionBar().getTabeAt(currentTab));
    ...
    private void loadSelectedForecast()
    {
        ...
        else
        {
            ...
            selectForcast(cityNameString); // load preferred city's forecast
        }  // end else
    ...
    // read previously saved city list from SharedPreferences
    ...
    {
        // load array of city names from resources
